...
for line in h:
	if '#' not in line:
		...
		print par
		fin=open('/Users/ahamanow/Desktop/ALMA/CO_search/ALMA_fields/template.param','r') #we gan give here an uniform directory
		fout=open(par.replace("_nozero.fits",".sofia"),'wt')
