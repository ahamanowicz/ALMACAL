...
uid='uid___A001_X340_X134.list.J0241-0815.concat.01.J0241-0815_B8' #file in
...
#from here the is big skip compared to regular cubeformcode, we dont choose spw sice the were chosen already andn we use concatenated data
